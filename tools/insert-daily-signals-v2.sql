-- Create a clean daily signal row under a new key so the app can bypass the oversized v1 row.
-- Run this in the Supabase SQL editor. This does not touch edgex_daily_signals_v1.

delete from traction_data
where
  user_id = 'jack_traction_hub_v1'
  and key = 'edgex_daily_signals_v2';
